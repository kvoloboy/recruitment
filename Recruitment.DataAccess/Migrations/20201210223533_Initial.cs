        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxPossibleMark = table.Column<double>(type: "float", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QuestionnaireResults_Candidates_CandidateId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinExperienceInYears = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "QuestionnaireToVacancyRelations",
                columns: table => new
                {
                    QuestionnaireId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuestionnaireToVacancyRelations", x => new { x.VacancyId, x.QuestionnaireId });
                    table.ForeignKey(
                        name: "FK_QuestionnaireToVacancyRelations_Questionnaires_QuestionnaireId",
                        column: x => x.QuestionnaireId,
                        principalTable: "Questionnaires",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_QuestionnaireToVacancyRelations_Vacancies_VacancyId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VacancyApplications", x => new { x.CandidateId, x.VacancyId });
                    table.ForeignKey(
                        name: "FK_VacancyApplications_Candidates_CandidateId",
                        column: x => x.CandidateId,
                        principalTable: "Candidates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuestionnaireResults_CandidateId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuestionnaireToVacancyRelations_QuestionnaireId",
                table: "QuestionnaireToVacancyRelations",
                column: "QuestionnaireId");
